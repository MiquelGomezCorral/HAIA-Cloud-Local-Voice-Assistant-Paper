...
\section{Proveedores Cloud y Complejidad del Ecosistema}
A lo largo de este proyecto, si bien se partió con el horizonte de tener la totalidad del asistente trabajando en local, se introdujo como contraparte evaluar la viabilidad con servicios en la nube para percibir los cambios en fluidez y calidad. Sin embargo, recurrir a proveedores \textit{cloud} añadió un grado de complejidad técnica y burocrática notable al proceso de desarrollo.
...
\begin{itemize}
    ...
    \item \textbf{Hugging Face:} Para la obtención de los modelos de representación vectorial (\textit{embeddings}), vitales para el RAG.
    \item \textbf{Tavily:} Se recurrió a esta API para la interconexión específica con las búsquedas web.
...
\begin{figure}[H]
    ...
    \caption{Estructura del sistema del asistente de voz}
    \label{fig:structure}
\end{figure}
...
\subsection{Indexación y persistencia de datos}
